    ...
    return (
        ...
        <div className="bg-[#004D43] min-h-[50vh] mt-10  flex flex-row items-center justify-center relative rounded-3xl mx-20  mb-10 md:min-h-[80vh]">
            ...
            <div className="absolute -top-24 -right-16 ">
                <div className="carousel rounded-box w-[840px] gap-10 h-[550px] hover:scale-105 ">
                    {reviews.map((reviews, index, shade) => (
                        shade = getRandomColor(colors),
                        
                        <div
                            key={index}
                            className={`carousel-item transition-opacity duration-1000 ease-in-out `}
                            

                        >
                            <div className={`card glass w-96 ${shade}`}>
                                <figure>
                                    <img src={reviews.img}
                                    alt="profile_page"
